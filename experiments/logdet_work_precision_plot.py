...
plt.rcParams.update(bundles.icml2022(column="full", family="sans-serif"))
...
ax["custom_vjp-value"].set_ylabel("Custom VJP | Error")
ax["custom_vjp-grad"].set_title("Logdet: Gradient")
ax["reference-value"].set_ylabel("Autodiff-of-SLQ | Error")
