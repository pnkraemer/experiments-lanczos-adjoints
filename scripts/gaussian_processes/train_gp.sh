...
time python experiments/applications/gaussian_process/error_metrics/gp_jax_test.py --name adjoints_small --seed 1 --num_data 400000 --rank_precon 500 --num_matvecs 10 --num_samples 1 --num_epochs 50 --cg_tol 1. --num_partitions 500;
